        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-10">
          <div>
            ...
            <p className="text-sm text-white/60 leading-relaxed">
              Mi futuro es Hoy.<br />
              Equipos de Compis agénticos especializados para PYMES.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 md:gap-2.5">
              <a href="#/privacidad" className="text-sm text-white/60 hover:text-white transition-colors">Privacidad</a>
              <a href="#/terminos" className="text-sm text-white/60 hover:text-white transition-colors">Términos</a>
              <a href="#/cookies" className="text-sm text-white/60 hover:text-white transition-colors">Cookies</a>
              <a href="#/aviso-legal" className="text-sm text-white/60 hover:text-white transition-colors">Aviso Legal</a>
            </div>
          </div>
        </div>

        <div className="mt-8 md:mt-10 pt-6 md:pt-8 border-t border-white/10 text-center">
          <p className="text-[12px] md:text-[13px] text-white/40">© 2026 BeeNoCode S.L. — Todos los derechos reservados</p>
        </div>
      </div>
    </footer>
  )
